...
var gallery_main = (function ($) {
  var _ = {
    ...
    initProperties: function () {
      ...
      // Toggle.
      $('<div class="toggle"></div>').appendTo(_.$gallery_main);
        ...
        _.$window
          .on("resize", function () {
            window.setTimeout(function () {
              _.$viewer.css(
                "width",
                _.$window.width() - _.$gallery_main.width()
              );
            }, 100);
          })
          .trigger("resize");
      ...
      _.$gallery_main
        ...
        .on("touchmove", function (event) {
          ...
          var th = _.$gallery_main.outerHeight(),
            ts =
              _.$gallery_main.get(0).scrollHeight - _.$gallery_main.scrollTop();

          if (
            (_.$gallery_main.scrollTop() <= 0 && diffY < 0) ||
            (ts > th - 2 && ts < th + 2 && diffY > 0)
          ) {
            event.preventDefault();
            event.stopPropagation();
    ...
    initViewer: function () {
      ...
      _.$gallery_thumbnails.on("click", ".thumbnail", function (event) {
        var $this = $(this);
      ...
      _.$gallery_thumbnails.children().each(function () {
        var $this = $(this),
    ...
    up: function () {
      ...
      var i,
        c = _.current,
        l = _.slides.length,
        tpr = _.settings.gallery_thumbnailsPerRow;
